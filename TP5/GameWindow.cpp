...
void GameWindow::gridClicked()
{
    ...
    if(checkWin()){
        ...
        playerWon_= (!player1Turn_) ? PLAYER_1 : PLAYER_2;
        player1name_->setText("WINNER");

    }
	if (checkDraw()) {
		// Logique lorsqu'il y a un match nul - À FAIRE
		// ...
	}
}
...
void GameWindow::reinitialisation() {
    // Logique lorsqu'on veut ré-initialiser le jeu - À FAIRE
    // ...
}
